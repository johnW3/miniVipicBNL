...
/* Generated from ../O.Common/vipic.dbd */
...
int vipic_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/root/epics/myvipic/ioc";
...
/* vipic_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"vipic_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    vipic_registerRecordDeviceDriver(*iocshPpdbbase);
}
